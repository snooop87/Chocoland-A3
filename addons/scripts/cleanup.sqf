...
while{true} do {
	...
	{	
		...
		if (_ttdPlanted>0) then {
			...
			} forEach ["TimeBombCore","Land_Money_F","Ruins_F","Land_BottlePlastic_V2_F","Land_BakedBeans_F","Land_SuitCase_F"];
		};
		...
		if (_ttdSmokes>0) then {
			...
			} forEach ["SmokeShell","CraterLong_small","CraterLong","Land_Airport_Tower_ruins_F","Land_TentHangar_V1_ruins_F","Land_Cargo_House_V1_ruins_F"];
		};
